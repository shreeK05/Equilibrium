...
describe('Equilibrium Autonomy & Lifecycle', () => {
    ...
    it('completes the full autonomous scheduling lifecycle', async () => {
        ...
        const task1 = await (0, supertest_1.default)(app_1.app)
            .post('/api/v1/tasks')
            .set('Authorization', `Bearer ${token}`)
            .send({
        ...
        const gen1 = await (0, supertest_1.default)(app_1.app)
        ...
        const physicsBlocks = gen1.body.blocks.filter((b) => b.taskId === task1.body.id);
        ...
        await (0, supertest_1.default)(app_1.app)
            ...
            .expect(200);
        // 7. Reschedule!
        const gen2 = await (0, supertest_1.default)(app_1.app)
...
//# sourceMappingURL=autonomy.integration.test.js.map